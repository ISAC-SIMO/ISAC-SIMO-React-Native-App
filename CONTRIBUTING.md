...
Priority areas for contributions are listed in the [Call to Action for Developers](https://www.isac-simo.net/docs/contribute/) section of the project documentation.

When contributing a major change to this repository, please first discuss the change you wish to make via an [issue](contributing/ISSUES.md) or by contacting the project team in the `#isac-simo` channel on
[Slack](https://callforcode.org/slack). Minor issues can simply be addressed by sending by a pull request.
...
reported by contacting the project team in the `#isac-simo` channel on
[Slack](https://callforcode.org/slack).
